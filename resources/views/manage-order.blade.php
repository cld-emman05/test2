								...
								<form><div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												{{ Form::text('jobname', 'Enter', ['class' => 'form-control border-input', $trigger])}}
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												{{ Form::text('jobType', 'Enter', ['class' => 'form-control border-input', $trigger])}}
											</div>
										</div>
									</div>
								</form>
										...
										<div class="form-group">
											{{ Form::label('quantity', 'Quantity') }}
												<div class="container">
													...
													{{ Form::text('quantity', '1', ['class' => 'quantity', $trigger])}}
								  ...
								  <div class="row">
									  <div class="col-lg-6">
										  <div class="form-group">
											 ...
											 {{ Form::text('size', 'Enter', ['class' => 'form-control border-input', $trigger])}}
										  </div>
									  </div>
								  </div>
								  ...
								  <div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											...
											{{ Form::text('lamination', 'Enter', ['class' => 'form-control border-input', $trigger])}}
										</div>
									</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											{{ Form::text('binding', 'Enter', ['class' => 'form-control border-input', $trigger])}}
										</div>
									</div>
									</div>
								  ...
								  <div class="row">
									  <div class="col-md-12">
										  <div class="form-group">
											...
											{{ Form::textarea('comments', 'Here can be your description', ['class' => 'form-control border-input', $trigger , 'row' => 5])}}
										  </div>
									  </div>
								  </div>

								  <div class="text-center">
								  	{{Form::button('Edit Order', ['class' => 'btn btn-warning btn-fill btn-wd'])}}
